package Alura.Listas_e_colecao_de_dados.Aula_1.Screen_Match.Principal;

import Alura.Listas_e_colecao_de_dados.Aula_1.Screen_Match.Pacotes.Modelos.Episodio;
import Alura.Listas_e_colecao_de_dados.Aula_1.Screen_Match.Pacotes.Modelos.Filme;
import Alura.Listas_e_colecao_de_dados.Aula_1.Screen_Match.Pacotes.Modelos.Serie;

import java.util.ArrayList;

// import Alura.Listas_e_colecao_de_dados.Aula_1.Screen_Match.Pacotes.Calculos.CalculadoraDeTempo;
import Alura.Listas_e_colecao_de_dados.Aula_1.Screen_Match.Pacotes.Calculos.FiltroRecomendacao;
...
public class Principal {
    public static void main(String[] args) {
        ...
        Filme Dogville = new Filme();
        Dogville.setAnoDeLancamento(2003);
        Dogville.setNome("Dogville");
        Dogville.setDuracaoEmMinutos(200);
        Dogville.avalia(10);

        ArrayList<Filme> listDeFilmes = new ArrayList<>();
        listDeFilmes.add(Dogville);
        listDeFilmes.add(Avatar);
        listDeFilmes.add(Kill_Bill);
        System.out.println("================================\nTamanho da lista : " + listDeFilmes.size());
